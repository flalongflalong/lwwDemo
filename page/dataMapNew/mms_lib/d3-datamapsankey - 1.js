d3.biHiSankey_1 = function () {
    ...
    biHiSankey_1.layout = function (iterations) {
    ...
    biHiSankey_1.linkSpacing = function (_) {
        if (!arguments.length) { return linkSpacing; }
        linkSpacing = +_;
        return biHiSankey_1;
    };

    biHiSankey_1.nodes = function (_) {
        if (!arguments.length) { return nodes; }
        nodes = _;
        return biHiSankey_1;
    };

    biHiSankey_1.nodeWidth = function (_) {
        if (!arguments.length) { return nodeWidth; }
        nodeWidth = +_;
        return biHiSankey_1;
    };

    biHiSankey_1.nodeHeight = function (_) {
        if (!arguments.length) { return nodeHeight; }
        nodeHeight = +_;
        return biHiSankey_1;
    };

    biHiSankey_1.nodeSpacing = function (_) {
        if (!arguments.length) { return nodeSpacing; }
        nodeSpacing = +_;
        return biHiSankey_1;
    };

    biHiSankey_1.nodeSpacingArray = function (_) {
        if (!arguments.length) { return nodeSpacingArray; }
        nodeSpacingArray = _;
        return biHiSankey_1;
    };

    biHiSankey_1.yDistanceMul = function (_) {
    ...
    biHiSankey_1.relayout = function () {
        computeLeftAndRightLinks();
        computeNodeValues();
        computeLinkYPositions();
        return biHiSankey_1;
    ...
    biHiSankey_1.size = function (_) {
        if (!arguments.length) { return size; }
        size = _;
        return biHiSankey_1;
    };

    biHiSankey_1.visibleLinks = function () {
        return visible(links);
    };

    biHiSankey_1.initializeNodes = function (callback) {
