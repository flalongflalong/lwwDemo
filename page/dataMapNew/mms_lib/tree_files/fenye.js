//-------------------分页js---------------------------------
var htmlPop = '<div class="pager-list"></div><div style="clear: both;"></div>'
		var alldata;
		var trArray = $('.table-striped tr:gt(0)');
		...
		var contentFenye = $('.table-striped')
	...
	$().ready(function () {
		$('div.pager-list').pageList({
			...
			clickCallback: function (currentPage) {  
				changeItem($(this),currentPage)
                console.info("currentPage:" + currentPage);
							
			}
		}); 
	}); 
	function changeItem(o,i) {
        var obj = $(o)[0];
